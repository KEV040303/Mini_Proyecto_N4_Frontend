      ...
      <main className="w-full flex flex-col justify-center content-center items-center">
        ...
        <section className="w-[845.91px] min-h-[580.54px] border-[#E0E0E0] border-[1px] rounded-xl px-11 py-2">
          <div className="flex flex-col gap-1 py-8">
            <h2 className="font-normal text-[24px] leading-[32.69px]">
              Change Info
            </h2>
            <p className="text-[#828282] font-medium text-[13px] leading-[17.71px]">
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-5 pb-8">
            ...
            >
              ...
              <h3 className="text-[#828282] font-medium text-[13px] leading-[17.71px]">
                CHANGE PHOTO
              </h3>
              <input
                id="profilePicture"
            ...
            <label htmlFor="name" className="flex flex-col gap-2">
              <h4 className="text-[13px] leading-[17.71px] text-[#4F4F4F]">
                Name
              </h4>
              <input
                id="name"
            ...
            <label htmlFor="bio" className="flex flex-col gap-2">
              ...
              <textarea
                ...
                className="text-[12px] leading-[17px] text-[#4F4F4F] h-[91.58px] placeholder:text-[13px] placeholder:leading-[17.71px] w-[416.93px] border-[1px] border-[#828282] rounded-lg p-6"
              ></textarea>
            </label>
            <label htmlFor="phone" className="flex flex-col gap-2">
              ...
              <input
                ...
                id="phone"
                name="phone"
                title="Ingrese un numero telefono de minimo 9 digitos"
                pattern="[0-9]{9,}"
        ...
        <footer className="pt-2 px-1 pb-12 flex justify-between w-[845.91px] text-[14px] leading-[19.07px] text-[#828282]">
          <p className="font-normal">
            created by{" "}
            <span className="underline font-semibold">KEV040303</span>
          </p>
